...
"}")
        ...
        self.analog_clock_frame.setMaximumSize(QtCore.QSize(450, 16777215))
        self.analog_clock_frame.setStyleSheet("")
        ...
        self.analog_clock_frame_contents.setMinimumSize(QtCore.QSize(280, 280))
        self.analog_clock_frame_contents.setMaximumSize(QtCore.QSize(280, 280))
        self.analog_clock_frame_contents.setStyleSheet("")
        ...
        self.verticalLayout_12.addWidget(self.analog_clock_frame_contents, 0, QtCore.Qt.AlignHCenter)
        self.gridLayout.addWidget(self.analog_clock_frame, 0, 0, 2, 1)
        self.hex_clock_frame = QtWidgets.QFrame(self.main_window_frame)
        self.hex_clock_frame.setMaximumSize(QtCore.QSize(450, 16777215))
        ...
        self.binary_clock_frame.setMaximumSize(QtCore.QSize(450, 16777215))
